...
class ProcessingActivity : AppCompatActivity() {
	...
	override fun onCreate(savedInstanceState : Bundle?) {
		...
		imageProcessor= CropMedicImageProcessor.getInstance(this,getString(R.string.firebaseModelName),contentResolver,getString(R.string.labelFileName))
	...
	private fun compareKeysandgetResult(buffer1: FloatBuffer , array1:FloatArray):Float{
		...
		Toast.makeText(this,"Euclidian Distance=$distance",Toast.LENGTH_SHORT).show()
		return  distance
	}
